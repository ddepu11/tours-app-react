const tours = [
  ...
  {
    id: "45584aasaedSASe",
    name: "Private Tour: Giza Pyramids, Sphinx, Memphis, Sakkara",
    info:
    ...
    image:
      "https://images.pexels.com/photos/3689859/pexels-photo-3689859.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940",
    price: "85,000",
  },
  {
    id: "7854asjjHIUYnka5",
    name: "Get to know one of the wonder, Taj Mahal",
    info:
  ...
  {
    id: "544578dfeewrpoiwJHJ",
    name: "Bangkok Day Tour: Thai Foodie Tour and Cooking Class (half day)",
    info:
      "Duration: 4 hours Meeting Point: 8:40am at Silom Thai Cooking School Finish Point: Silom Thai Cooking School Itinerary: After meeting your chef, head to the bustling outdoor market and collect the ingredients needed to make your own authentic 5-course Thai cuisine. Your chef guide will explain the local foods and show you how Bangkok bargaining is done. After the market, return to the cooking school and get hands-on experience as you transform those ingredients into a masterpiece. You'll concoct curry paste, the most important part of all Thai dishes, from scratch by grinding the fresh herbs and spices in a stone mortar, releasing a wonderful aroma. Also learn how to make coconut milk and correctly cook rice to that perfect consistency. The main courses will vary by day, but each class instructs the making of a soup, salad, appetizer, main-course, and dessert. At the end of the class, enjoy your creation for lunch. And you get to keep the recipes! Note that this Day Tour is operated by one of G Adventures' preferred suppliers and will be a shared service with other non-G Adventures travellers.",
    image:
      "https://images.pexels.com/photos/1031659/pexels-photo-1031659.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940",
    price: "40,000",
  },
];
